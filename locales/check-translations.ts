...
const INCONSISTENT_TRANSLATION_WHITELIST = new Set([
  ...
  "You can go to the service you need to use and find out what you can do if you cannot prove your identity with GOV.UK One Login.",
  "You can prove your identity using the GOV.UK One Login app or at a Post Office.",
]);
