...
export default {
  ...
  MAM_SPINNER_REQUEST_TIMEOUT: Number(
    process.env.MAM_SPINNER_REQUEST_TIMEOUT || 600000,
  ),
  SPINNER_REQUEST_INTERVAL: Number(
    process.env.SPINNER_REQUEST_INTERVAL || 3000,
  ),
  SPINNER_REQUEST_LONG_WAIT_INTERVAL: Number(
    process.env.SPINNER_REQUEST_LONG_WAIT_INTERVAL || 60000,
  ),
  POST_OFFICE_VISIT_BY_DAYS: 15,
  DOCUMENT_EXPIRY_GRACE_PERIOD: 90,
  DAD_SPINNER_REQUEST_TIMEOUT: Number(
  ...
  ENABLE_PROGRESS_SPINNER_BUTTON:
    process.env.ENABLE_PROGRESS_SPINNER_BUTTON === "true",
